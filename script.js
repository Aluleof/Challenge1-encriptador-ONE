...
const mensaje = document.querySelector(".input-text2");
const containerImage = document.querySelector(".container-content-rigth-image");
const inputTextResult = document.querySelector(".input-text2");
const containerShadowAlert = document.querySelector(".container-alerts-shadow");
